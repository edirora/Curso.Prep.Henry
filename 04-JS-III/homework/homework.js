...
function numeroMasGrande(numeros) {
  ...
  // Tu código:
   ...
   let masGrande = Math.max.apply(null,numeros);
   return masGrande;
}
...
function cuentoElementos(arreglo){
 ...
 // let cuentoElementos = [2,19,1,23,65,9,0,21,35,];
   arreglo = arreglo.filter(num => num > 18);
...
function mesesDelAño(array) {
  ...
  // Tu código:
  let filteredArray = array.filter((mes) => {
  ...
  while (i<10)
{
    ...
    nuevoValor.push(numero=numero +2);     
    i++;    
} 
  if(interrupcion)
      {
